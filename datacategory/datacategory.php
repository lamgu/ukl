                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit-category.php?id=<?php echo $row['ID_category'] ?>" class="edit">Edit</a> | <a href="proses-hapus.php?idk=<?php echo $row['ID_category'] ?>" onclick="return confirm('Yakin Ingin Hapus?')" class="hapus">Hapus</a>
                                    </td>
                                </tr>
                            <?php
                            }
